...
const Services = () => {
  return (
    <div
      className="bg-slate-100 mt-[20px]  relative max-w-[auto] min-h-[50vh] p-4"
      name="service"
    >
      ...
      <div className="mt-4">
        <p className="text-2xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500">NFTs</p>
        <div className="flex 2xl:flex-row xs:flex-col items-center mt-4 md:flex-row md:flex xl:flex-row xl:flex flex-wrap gap-4 justify-center">
          <div className="flex flex-col max-w-[auto] min-h-[400px] p-4 bg-white rounded text-[16px]">
            <img
